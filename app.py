...
st.markdown("""
    ...
    /* Restyle native link buttons to solid Black & Gold storefront badges */
    div.stLinkButton > a {
...
with tab_store:
    ...
    # ✅ FIX: Explicitly defined proportions grid with NO broken syntax layout bugs
        ...
        if catalog_df.empty:
            ...
            for index, watch in catalog_df.iterrows():
                with st.container():
                    ...
                    # THE BULLETPROOF DIRECT COMMERCE TUNNEL:
                    ...
                    # Native link button sitting directly on the card. Instant redirect with NO browser traps!
                    st.link_button("🛒 Place Order via WhatsApp DM", url=whatsapp_href, use_container_width=True)
