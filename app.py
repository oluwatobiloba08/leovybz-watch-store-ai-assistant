...
st.markdown("""
    ...
    /* Restyle the "Place Order" button to solid Black & Gold */
    div.stButton > button {
            ...
            for index, watch in catalog_df.iterrows():
                with st.container():
                    ...
                    if st.button("Place Order", key=f"order_btn_{index}", use_container_width=True):
                        ...
                        # Builds a clean checkout script targeting your specific DM number
                        ...
                        # Direct DM routing API link using your requested phone parameter
                        ...
                        st.markdown(f"""
                            <div class="whatsapp-link-box">
                                <a href="{whatsapp_href}" target="_blank">➡️ CLICK HERE TO OPEN WHATSAPP DM & PLACE ORDER</a>
                            </div>
                        """, unsafe_allow_html=True)
                        st.markdown("---")
