...
# 🔥 ADVANCED CUSTOM CSS INJECTION: SOLID BLACK LUXURY BACKGROUNDS
st.markdown("""
    <style>
        ...
        if catalog_df.empty:
            ...
            for index, watch in catalog_df.iterrows():
                with st.container():
                    ...
                    target_phone = "07076967421"  # Your primary WhatsApp number string
                    ...
                    if st.button("Place Order", key=f"place_order_{index}", use_container_width=True):
                        ...
                        # 2. Automated Clipboard Number Injection Block
